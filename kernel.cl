	...
	const unsigned int n_contact)
{
    ...
    out_omg_xA[id] = JuA[id+n_contact*0]*gam.x+JvA[id+n_contact*0]*gam.y+JwA[id+n_contact*0]*gam.z;
    out_omg_yA[id] = JuA[id+n_contact*1]*gam.x+JvA[id+n_contact*1]*gam.y+JwA[id+n_contact*1]*gam.z;
    out_omg_zA[id] = JuA[id+n_contact*2]*gam.x+JvA[id+n_contact*2]*gam.y+JwA[id+n_contact*2]*gam.z;
